...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    {
        if (Main.instance.commandManager.execute(message))
            return;
        if (message.startsWith(CommandManager.Chat_Prefix)) {
            Command.msg("Command doesn't exist! Try #help.");
            return;
        }
