package net.sssssssthedev.SmartClient.ui.ingame;
...
public class CustomIngameGui extends GuiIngame {
    ...
    private void renderInfo() {
        ...
        font.drawString("Smart Client", 2, 2, 0xff1C4BE0);
        GL11.glPopMatrix();

        font.drawString(ChatFormatting.AQUA + "FPS" + ChatFormatting.GRAY + "> " + ChatFormatting.WHITE + Minecraft.getDebugFPS(), 5, 22, 0xffffffff);
    ...
    private void renderPlayer() {
        GuiInventory.drawEntityOnScreen(80, 65, 25, 0, 0, mc.thePlayer);
    }
}
