...
import net.sssssssthedev.SmartClient.event.impl.ClientTickEvent;
import net.sssssssthedev.SmartClient.event.impl.KeyEvent;
import net.sssssssthedev.SmartClient.gui.SplashProgress;
import net.sssssssthedev.SmartClient.ui.ingame.CustomIngameGui;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public void launchIntegratedServer(String folderName, String worldName, WorldSettings worldSettingsIn)
    {
        ...
        Client.getInstance().getDiscordMYRPC().update("Playing Singleplayer", "In Game");
    }
