...
import net.sssssssthedev.SmartClient.event.impl.BlockBBEvent;
...
public class Block
{
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity)
    {
        ...
        CollideEvent collideEvent = new CollideEvent(collidingEntity, pos.getX(), pos.getY(), pos.getZ(), axisalignedbb, this);
        collideEvent.call();
        axisalignedbb = collideEvent.getBoundingBox();
