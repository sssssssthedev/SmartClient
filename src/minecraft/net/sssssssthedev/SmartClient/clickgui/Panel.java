...
public class Panel {
	 ...
	 */
		...
		public void drawScreen(int mouseX, int mouseY, float partialTicks) {
			...
			}else if(Main.instance.settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("JellyLike")){
			...
			if (this.extended && !Elements.isEmpty()) {
				...
				int epanelcolor = Main.instance.settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("New") ? 0xff232323 : Main.instance.settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("JellyLike") ? 0xbb151515 : 0;
