...
import ro.sssssssthedev.AntiCheat.packet.handlers.PacketHandler1_9_R2;
...
public final class PacketRegister1_9_R2 {
    ...
    public PacketRegister1_9_R2(final PlayerData playerData) {
        ...
        AntiCheatAPI.INSTANCE.getPacketExecutor().execute(() -> new PacketHandler1_9_R2(entityPlayer.server, entityPlayer.playerConnection.networkManager, entityPlayer, playerData));
    }
