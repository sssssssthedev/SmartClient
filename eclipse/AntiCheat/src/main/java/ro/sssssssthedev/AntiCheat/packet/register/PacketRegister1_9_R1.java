...
import ro.sssssssthedev.AntiCheat.packet.handlers.PacketHandler1_9_R1;
...
public final class PacketRegister1_9_R1 {
    ...
    public PacketRegister1_9_R1(final PlayerData playerData) {
        ...
        AntiCheatAPI.INSTANCE.getPacketExecutor().execute(() -> new PacketHandler1_9_R1(entityPlayer.server, entityPlayer.playerConnection.networkManager, entityPlayer, playerData));
    }
